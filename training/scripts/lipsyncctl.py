...
def build_parser() -> argparse.ArgumentParser:
    ...
    prewarm.add_argument("--config", default="configs/syncnet_mirror_batch64.yaml")
    ...
    sync_align.add_argument("--config", default="configs/syncnet_mirror_batch64.yaml")
    ...
    train_syncnet.add_argument("--config", default="configs/syncnet_mirror_batch64.yaml")
