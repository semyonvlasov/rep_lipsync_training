...
CONFIG="$TRAINING_ROOT/configs/syncnet_mirror_rtx5080_medium_20260404.yaml"
OUTPUT_DIR_REL="output/training_rtx5080_syncnet_mirror_medium_20260404"
RUN_OUTPUT="$TRAINING_ROOT/$OUTPUT_DIR_REL"
RUN_SYNCNET_DIR="$RUN_OUTPUT/syncnet"
SPLIT_DIR="$TRAINING_ROOT/output/syncnet_mirror_rtx5080_20260404_split"
...
print(
    f"[syncnet-launcher] built split total={len(ordered)} "
