...
CONFIG="${CONFIG:-$TRAINING_ROOT/configs/generator_mirror_gan_tiltaware_dataset_adaptive.yaml}"
OUTPUT_DIR_REL="output/generator_mirror_gan_tiltaware_dataset_adaptive"
SPLIT_DIR="$TRAINING_ROOT/output/generator_mirror_gan_tiltaware_dataset_adaptive_split"
PREPARED_DIR="$TRAINING_ROOT/output/generator_mirror_gan_tiltaware_dataset_adaptive_prepared"
SPEAKER_LIST="$SPLIT_DIR/train_snapshot.txt"
VAL_SPEAKER_LIST="$SPLIT_DIR/val_snapshot.txt"
VAL_SNAPSHOT_SOURCE="${VAL_SNAPSHOT_SOURCE:-$TRAINING_ROOT/snapshots/val_snapshot_talkvid_balanced_eth_gender_current_20260430.txt}"
...
HDTF_ROOT_REL="${HDTF_ROOT_REL:-data/hdtf/processed}"
TALKVID_ROOT_REL="${TALKVID_ROOT_REL:-data/talkvid/processed}"
