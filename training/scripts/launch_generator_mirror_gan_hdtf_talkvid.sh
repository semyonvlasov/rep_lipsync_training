...
CONFIG="$TRAINING_ROOT/configs/generator_mirror_gan_hdtf_talkvid.yaml"
OUTPUT_DIR_REL="output/generator_mirror_gan_hdtf_talkvid"
SPLIT_DIR="$TRAINING_ROOT/output/generator_mirror_gan_hdtf_talkvid_split"
SPEAKER_LIST="$SPLIT_DIR/train_snapshot.txt"
VAL_SPEAKER_LIST="$SPLIT_DIR/val_snapshot.txt"
SYNCNET="${SYNCNET_CKPT:-$TRAINING_ROOT/../../models/wav2lip/checkpoints/lipsync_expert.pth}"
