...
STAGE_ROOT = os.path.dirname(SCRIPT_DIR)
PROCESS_ROOT = os.path.dirname(STAGE_ROOT)
DATASET_PREP_ROOT = os.path.dirname(PROCESS_ROOT)
REPO_ROOT = os.path.dirname(DATASET_PREP_ROOT)
